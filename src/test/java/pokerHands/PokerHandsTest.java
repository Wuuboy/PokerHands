...
public class PokerHandsTest {
  ...
  @Test
  public void should_return_player1_win_when_input_2H_2D_2S_9C_9D_and_3H_3D_3S_3C_KD() {

    Card card1 = new Card("2H");
    Card card2 = new Card("2D");
    Card card3 = new Card("2S");
    Card card4 = new Card("9C");
    Card card5 = new Card("9D");
    List<Card>cardList1 = Arrays.asList(card1,card2,card3,card4,card5);
    Card card6 = new Card("3H");
  ...
  @Test
  public void should_return_player1_win_when_input_2H_2D_2S_9C_9D_and_2H_2D_2S_2C_3D() {
    ...
    Card card7 = new Card("2D");
    Card card8 = new Card("2S");
    Card card9 = new Card("2C");
    Card card10 = new Card("3D");
    List<Card>cardList2 = Arrays.asList(card6,card7,card8,card9,card10);
  ...
  @Test
  public void should_return_player1_win_when_input_2H_3D_4S_5C_6D_and_2H_2D_2S_2C_3D() {
